...
class SFAKD(Distiller):
    def __init__(self, student, teacher, cfg, s_n, t_n, t_cls):
        ...
        self.feat_t_dim = t_n
        self.t_cls = t_cls
        self.cut_off = cfg.SFAKD.CUT_OFF
...
class SFA_Module(nn.Module):
    def __init__(self, in_channels, out_channels, shapes, cut_off_ratio):
    ...
    def forward(self, x):
        ...
        # print(h, w)
        mask = make_gaussian_mask(h, w, self.cut_off_ratio)
